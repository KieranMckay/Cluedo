...
/**
 * A panel loaded in to the initial starting frame pre-game of cluedo
 * controls the selection process for players picking characters and inputting their names
 *
 * @author Kieran Mckay
 */
